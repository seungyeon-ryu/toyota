...
;(function(factory) {
    ...
    Slick.prototype.getSlideCount = function() {
        ...
        if (_.options.swipeToSlide === true) {
            _.$slideTrack.find('.slick-slide').each(function(index, slide) {
                if (slide.offsetLeft - centerOffset + ($(slide).outerWidth() / 10) > (_.swipeLeft * -1)) {
                    swipedSlide = slide;
                    return false;
                }
            });
    ...
    Slick.prototype.swipeDirection = function() {
        ...
        if (_.options.verticalSwiping === true) {
            if ((swipeAngle >= (90 - _.options.swipeAngleOffset)) && (swipeAngle <= (90 + _.options.swipeAngleOffset))) {
                return 'down';
            } else {
                return 'up';
            }
    ...
    Slick.prototype.swipeEnd = function(event) {
        ...
        _.interrupted = false;
        _.shouldClick = ( _.touchObject.swipeLength > 20 ) ? false : true;
    ...
    Slick.prototype.swipeMove = function(event) {
        ...
        if (!_.options.verticalSwiping && !_.swiping && verticalSwipeLength > 30) {
            _.scrolling = true;
            return false;
        }
