            ...
            mkSlide : function(num){
                ...
                for(var i = 0; i < setVal.stru[num].subcategory.length; i++){
                    ...
                    var subtitle = "",
                        ...
                        if(setVal.subtitle){
                            if(setVal.stru[num].subcategory[i].descript == undefined ||  setVal.stru[num].subcategory[i].descript == null){
                                subtitle = '<div class="subtitle"><h3>' + setVal.stru[num].subcategory[i].subtitle + '</h3></div>';
                            }else{
                                descVal = '<p>' + setVal.stru[num].subcategory[i].descript + '</p>';
                                subtitle = '<div class="subtitle"><h3>' + setVal.stru[num].subcategory[i].subtitle + '</h3>' + descVal + '</div>';
                            }
                        }
                    ...
                    $('<li></li>').appendTo(_this.find('.viSlider-slide')).css({
                        ...
                        .html('<span class="indexNumber">'+ indexNumber + '</span>')
                        .append(subtitle).append(''+
                            '<div class="cont3_pop">'+
                                '<div class="cont3_popInner">'+
                                    '<p>'+setVal.stru[num].subcategory[i].popupText+'</p>'+
                                '</div>'+
                                '<button class="slide_popClose"><img src="../../images/model_view/m_prius/image/slide_popClose.png" alt="" class="wt100"></button>'+
                            '</div>'+
                            '');

//                    if(setVal.stru[num].subcategory[i].descript != undefined){
//                    $('.viSlider-slide').find('li').append('<p class="more_view">'+setVal.stru[num].subcategory[i].descript+'</>');
//                    }
                ...
                $('.subtitle > p').on('click', function(){
                    var idx = $(this).closest('li');

                    idx.addClass('slide_popView');
                });

                $('.slide_popClose').on('click', function(){
                    $(this).closest('li').removeClass('slide_popView');
                });
            },
            //mkSlide
            sortSlide : function(){
